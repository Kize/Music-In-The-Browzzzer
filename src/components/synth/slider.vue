  ...
  export default {
    ...
    methods: {
      ...
      drag(event) {
        ...
        //
        // const increment = this.origin.y - (event.clientY - ctm.f) / ctm.d
        // const viewBoxRatio = this.height / this.viewBoxDimensions.height
        // this.updatePosition(increment * viewBoxRatio)
      },
      wheel(event) {
        event.preventDefault()
